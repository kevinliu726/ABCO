...
const AddAccountModal = ({ open, handleClose, handleEnter }) => {
    ...
    <Dialog classes={{ paper: classes.dialog }} open={open} onClose={handleCancel} aria-labelledby="form-dialog-title">
      ...
      <DialogContent className={classes.dialogContent}>
        <FormControl className={classes.form} variant="outlined">
          <InputLabel htmlFor="search">Name</InputLabel>
          <OutlinedInput id="search" type="text" autoComplete="off" labelWidth={90} />
        </FormControl>
        <FormControl className={classes.form} variant="outlined">
