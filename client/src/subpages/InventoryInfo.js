    ...
    <div className="table">
      ...
      <Table>
        <TableHead>
          <TableRow>
            <TableCell width="40%">
              <TextField id="outlined-search" autoComplete="off" label="帳號" type="search" />
            </TableCell>
            <TableCell width="40%">
              <TextField id="outlined-search" autoComplete="off" label="股票代碼" type="search" />
            </TableCell>
            <TableCell width="20%" style={{ textAlign: "center" }}>
              <button style={{ width: "100%" }}>查詢</button>
            </TableCell>
          </TableRow>
        </TableHead>
      </Table>
